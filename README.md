...
A physics simulator and visualizer that demonstrates how launch angles and velocities affect a projectile's trajectory. It simulates thousands of parameter combinations to visualize the optimal conditions for max distance and understand trade-offs between range and height. 
